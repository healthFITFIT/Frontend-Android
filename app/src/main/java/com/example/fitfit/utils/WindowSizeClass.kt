package com.example.fitfit.utils
...
import androidx.compose.ui.unit.dp
import com.example.core.ui.designsystem.components.NAVIGATION_BOTTOM_BAR_WIDTH
...
class WindowSizeClass private constructor(
    ...
    companion object {
        ...
        fun calculateFromSize(size: DpSize): WindowSizeClass {
            ...
            val windowUse2Panes = getUse2Panes(size.width, windowWidthSizeClass)
